...
class FileLoggerTestCase extends TestCase
{
    ...
    public function testGetLogsWithArrayMode()
    {
        ...
        $logger->log('-->', 'HELP' . FtpBridge::CRLF);
    ...
    public function testCountWithPlainMode()
    {
        ...
        $logger->log('<--',
            "220---------- Welcome to Pure-FTPd [privsep] [TLS] ----------
                ...
                220 You will be disconnected after 60 seconds of inactivity" . FtpBridge::CRLF);
    ...
    public function testLogWithPlainMode()
    {
        ...
        $this->assertNull($logger->log('-->', 'NOOP' . FtpBridge::CRLF));
        $this->assertSame('--> NOOP' . FtpBridge::CRLF, $logger->getLogs());
